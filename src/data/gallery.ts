...
export const GALLERY_VIDEOS: GalleryVideo[] = [
  ...
  { src: '/A V TEC VIDEOS AND IMAGES copy/VID-20240224-WA0022.mp4', title: 'Live Concert Audio Tuning', service: 'Audio Systems', equipment: 'D&B SL Subwoofers', duration: '1:40' },
  ...
  { src: '/A V TEC VIDEOS AND IMAGES copy/VID-20241129-WA0000.mp4', title: 'Main Stage Rigging Load Test', service: 'Trussing & Rigging', equipment: 'Prolyte H40V Roof Grid', duration: '1:15' },
  { src: '/A V TEC VIDEOS AND IMAGES copy/VID-20241129-WA0001.mp4', title: 'Outdoor LED Screen Calibration', service: 'Video & LED Walls', equipment: 'Color Calibration & Processor', duration: '1:25' },
  { src: '/A V TEC VIDEOS AND IMAGES copy/VID_112481231_001117_930.mp4', title: 'Main Stage Audio Soundcheck', service: 'Audio Systems', equipment: 'D&B Line Array System', duration: '2:15' },
  { src: '/A V TEC VIDEOS AND IMAGES copy/VID_140450716_172943_169.mp4', title: 'Stage Lighting Beam Test', service: 'Stage Lighting', equipment: 'Moving Heads', duration: '1:55' },
  ...
  { src: '/A V TEC VIDEOS AND IMAGES copy/VID_20220514_214821.mp4', title: 'Concert Night Live Performance', service: 'Event Production', equipment: 'Complete Live Show AV', duration: '4:15' },
  ...
  { src: '/A V TEC VIDEOS AND IMAGES copy/VID_207590509_235404_853.mp4', title: 'Night Show Visual & Sound Impact', service: 'Event Production', equipment: 'Visuals & Sound Rig', duration: '1:45' },
  ...
  { src: '/A V TEC VIDEOS AND IMAGES copy/VID_35540514_070109_776.mp4', title: 'Truss Tower Erection & Pinning', service: 'Trussing & Rigging', equipment: 'Truss Towers', duration: '1:40' },
  { src: '/A V TEC VIDEOS AND IMAGES copy/VID_784691004_031135_704.mp4', title: 'Main Stage Line Array Rigging', service: 'Audio Systems', equipment: 'Line Array Hoists', duration: '2:15' },
  { src: '/A V TEC VIDEOS AND IMAGES copy/VID_83180428_103514_355.mp4', title: 'Corporate AV System Test', service: 'Installs & Integrations', equipment: 'Corporate AV', duration: '1:10' },
  { src: '/A V TEC VIDEOS AND IMAGES copy/VID_83471107_143512_749.mp4', title: 'Monitor Desk Pre-Show Calibration', service: 'Audio Systems', equipment: 'Monitor Console', duration: '1:05' },
  { src: '/A V TEC VIDEOS AND IMAGES copy/VID_85011123_203826_051.mp4', title: 'Concert Finale Lighting FX', service: 'Stage Lighting', equipment: 'Strobe & Moving Beams', duration: '1:15' },
  { src: '/A V TEC VIDEOS AND IMAGES copy/VID_99750223_110046_285.mp4', title: 'Technical Crew Sync & Briefing', service: 'Tech Consultancy', equipment: 'Crew Comms System', duration: '1:20' }
];
