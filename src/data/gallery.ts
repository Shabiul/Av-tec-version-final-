...
export const GALLERY_VIDEOS: GalleryVideo[] = [
  ...
  { src: '/videos/VID-20231120-WA0008.mp4', title: 'Destination Wedding Stage Wash', service: 'Stage Lighting', equipment: 'Astera AX1 Wireless Lights', duration: '1:15' },
  { src: '/videos/VID-20240109-WA0001.mp4', title: 'Corporate Launch Presentation', service: 'Video & LED Walls', equipment: 'ATEM Switching & Video Wall', duration: '1:30' },
  { src: '/videos/VID-20240223-WA0024.mp4', title: 'Stage Lighting Timecode Sequence', service: 'Stage Lighting', equipment: 'Clay Paky Sharpy Fixtures', duration: '1:45' },
  { src: '/videos/VID-20240223-WA0026.mp4', title: 'Ground Support Trussing Load-In', service: 'Trussing & Rigging', equipment: 'CM Lodestar Hoists & Truss', duration: '2:20' },
  { src: '/videos/VID-20240224-WA0017.mp4', title: 'FOH Soundcheck Session', service: 'Audio Systems', equipment: 'DiGiCo Console & Line Array', duration: '1:10' },
  { src: '/videos/VID-20240224-WA0022.mp4', title: 'Stage Monitor Tuning', service: 'Audio Systems', equipment: 'Wedge Monitor Setup', duration: '1:30' },
  { src: '/videos/VID-20240505-WA0008.mp4', title: 'Outdoor Music Festival Highlights', service: 'Event Production', equipment: 'Complete Festival AV Rig', duration: '2:15' },
  { src: '/videos/VID-20240505-WA0009.mp4', title: 'P2.5 Outdoor LED Wall Playback', service: 'Video & LED Walls', equipment: 'P2.5 Outdoor LED Video Screen', duration: '2:50' },
  { src: '/videos/VID-20240505-WA0010.mp4', title: 'Moving Head Beam Effects', service: 'Stage Lighting', equipment: 'Robe MegaPointe Beams', duration: '1:30' },
  { src: '/videos/VID-20240921-WA0011.mp4', title: 'Show Control & Calling Center', service: 'Tech Consultancy', equipment: 'Central Show Control Desk', duration: '1:50' },
  { src: '/videos/VID-20241112-WA0000.mp4', title: 'Permanent AV System Commissioning', service: 'Installs & Integrations', equipment: 'Auditorium AV Setup', duration: '2:10' },
  { src: '/videos/VID-20241123-WA0004.mp4', title: 'Stage Lighting & Ambience Warmup', service: 'Stage Lighting', equipment: 'Warm LED Wash Fixtures', duration: '1:20' },
  { src: '/videos/VID-20241123-WA0006.mp4', title: 'Corporate Boardroom System Test', service: 'Installs & Integrations', equipment: 'Poly Studio & Crestron', duration: '1:05' },
  { src: '/videos/VID-20241123-WA0009.mp4', title: 'Monitor Console Wireless Coordination', service: 'Audio Systems', equipment: 'Shure Axient Digital Mics', duration: '1:40' },
  { src: '/videos/VID-20241129-WA0000.mp4', title: 'Audio System Power-Up Test', service: 'Audio Systems', equipment: 'Amplifier Startup', duration: '0:45' },
  { src: '/videos/VID-20241129-WA0001.mp4', title: 'LED Screen Signal Verification', service: 'Video & LED Walls', equipment: 'LED Signal Test', duration: '1:00' },
  { src: '/videos/VID-20260402-WA0017.mp4', title: 'Corporate Event Stage Setup', service: 'Event Production', equipment: 'Stage & AV Build', duration: '1:30' },
  { src: '/videos/VID-20260523-WA0012.mp4', title: 'Wedding Lighting Reveal', service: 'Stage Lighting', equipment: 'Wedding Lighting Rig', duration: '1:15' },
  { src: '/videos/VID-20260625-WA0011.mp4', title: 'Festival Stage Night Show', service: 'Event Production', equipment: 'Festival Night Rig', duration: '3:00' },
  { src: '/videos/VID-20260701-WA0001.mp4', title: 'Audio Cable Run Timelapse', service: 'Audio Systems', equipment: 'Cable Infrastructure', duration: '0:50' },
  { src: '/videos/VID-20260701-WA0002.mp4', title: 'Truss Assembly Timelapse', service: 'Trussing & Rigging', equipment: 'Truss Build', duration: '1:00' },
  { src: '/videos/IMG_6585.MP4', title: 'Lighting & Truss System Demo', service: 'Stage Lighting', equipment: 'Robe Moving Heads & Prolyte Truss', duration: '2:10' },
  { src: '/videos/IMG_6167.MP4', title: 'LED Wall Content Playback', service: 'Video & LED Walls', equipment: 'LED Wall System', duration: '1:30' },
  { src: '/videos/IMG_7355.MP4', title: 'Concert Light Show', service: 'Stage Lighting', equipment: 'Moving Head Show', duration: '2:00' },
  { src: '/videos/IMG_2552.MP4', title: 'Full Event Production Walkthrough', service: 'Event Production', equipment: 'Complete AV Setup', duration: '5:00' },
  { src: '/videos/VID_112481231_001117_930.mp4', title: 'Stage Lighting Test Sequence', service: 'Stage Lighting', equipment: 'Moving Head Test', duration: '1:30' },
  { src: '/videos/VID_140450716_172943_169.mp4', title: 'Audio System Calibration', service: 'Audio Systems', equipment: 'System Tuning', duration: '1:45' },
  { src: '/videos/VID_20211127_020914.mp4', title: 'Arena Concert Production', service: 'Event Production', equipment: 'Full Arena Rig', duration: '3:10' },
  { src: '/videos/VID_20220419_230555.mp4', title: 'Product Launch Stage Production', service: 'Video & LED Walls', equipment: 'LED Walls & Lighting', duration: '3:40' },
  { src: '/videos/VID_20220513_200910.mp4', title: 'Destination Wedding Night Production', service: 'Stage Lighting', equipment: 'Ambient Wash & Spotlights', duration: '2:25' },
  { src: '/videos/VID_20220514_102256.mp4', title: 'Corporate Conference Morning Setup', service: 'Video & LED Walls', equipment: 'Conference AV Systems', duration: '2:15' },
  { src: '/videos/VID_20220514_110326.mp4', title: 'FOH Desk Audio Calibration', service: 'Audio Systems', equipment: 'Digital Mixing Console', duration: '2:00' },
  { src: '/videos/VID_20220514_215550.mp4', title: 'Lighting Strobe & Laser Show', service: 'Stage Lighting', equipment: 'Strobe & Laser Rig', duration: '2:30' },
  { src: '/videos/VID_20220715_101545.mp4', title: 'Rigging Safety & Load Inspection', service: 'Trussing & Rigging', equipment: 'Rigging Hardware', duration: '3:15' },
  { src: '/videos/VID_20220806_072641.mp4', title: 'Outdoor Screen Sunrise Test', service: 'Video & LED Walls', equipment: 'Outdoor P3.9 LED', duration: '2:10' },
  { src: '/videos/VID_20220806_072719.mp4', title: 'Stage Sound System Power-Up', service: 'Audio Systems', equipment: 'Power Amplifiers & Subs', duration: '2:40' },
  { src: '/videos/VID_20230808_223814.mp4', title: 'Night Show Full Production', service: 'Event Production', equipment: 'Night Show Rig', duration: '2:30' },
  { src: '/videos/VID_20240316_170145.mp4', title: 'Daylight LED Wall Test', service: 'Video & LED Walls', equipment: 'Outdoor LED Panel', duration: '2:00' },
  { src: '/videos/VID_207590509_235404_853.mp4', title: 'Beam Effect Choreography', service: 'Stage Lighting', equipment: 'Beam Fixtures', duration: '1:30' },
  { src: '/videos/VID_236470801_043607_994.mp4', title: 'Stage Light Chase Pattern Test', service: 'Stage Lighting', equipment: 'Moving Head Fixtures', duration: '1:25' },
  { src: '/videos/VID_241460317_020746_261.mp4', title: 'LED Video Processor Signal Check', service: 'Video & LED Walls', equipment: 'Video Processor', duration: '1:30' },
  { src: '/videos/VID_35540514_070109_776.mp4', title: 'Festival Load-In Timelapse', service: 'Event Production', equipment: 'Load-In & Build', duration: '1:45' },
  { src: '/videos/VID_784691004_031135_704.mp4', title: 'Concert Full Show Recording', service: 'Event Production', equipment: 'Full Concert Production', duration: '3:00' },
  { src: '/videos/VID_83180428_103514_355.mp4', title: 'Moving Head Pan & Tilt Demo', service: 'Stage Lighting', equipment: 'Moving Head Demo', duration: '1:00' },
  { src: '/videos/VID_83471107_143512_749.mp4', title: 'LED Wall Colour Test', service: 'Video & LED Walls', equipment: 'LED Colour Calibration', duration: '0:50' },
  { src: '/videos/VID_85011123_203826_051.mp4', title: 'Ambient Lighting Walkthrough', service: 'Stage Lighting', equipment: 'Ambient Fixtures', duration: '1:00' },
  { src: '/videos/VID_99750223_110046_285.mp4', title: 'Truss Ground Support Assembly', service: 'Trussing & Rigging', equipment: 'Ground Support', duration: '1:15' },
  { src: '/videos/VID_20220514_215833.mp4', title: 'Live Festival Crowd Audio', service: 'Audio Systems', equipment: 'D&B Line Array', duration: '3:50' },
];
