  ...
  audio: {
    ...
    subServices: [
      ...
      },
      {
        ...
        equipment: ['OSL Digital Conference Mics', 'Digital wireless Conference Mics', 'Language Interpretation and Translation Booths', 'Clear Communication Wireless  (8 x 2 Sets)'],
    ...
    equipment: [
      ...
      'Clear Communication Wireless  (8 x 2 Sets)',
    ],
  ...
  consultancy: {
    ...
    subServices: [
      ...
      },
      {
        ...
        description: 'Planning 8-channel wireless and wired clear communication networks for technical crew synchronization.',
        equipment: ['Clear Communication Wireless  (8 x 2 Sets)', 'Clear Communication Wired (8 x 2 Sets)', 'SC48 - 48 Channel Digital Audio Mixer', 'Digital Audio Recorder'],
